...
def main():
    ...
    running_in_ci = os.environ.get("GITHUB_ACTIONS") or os.environ.get("CI")

    if running_in_ci:
        print("Running in CI / headless environment. Skipping GUI loop.")
        # Optionally, run headless logic tests here if desired
        return
